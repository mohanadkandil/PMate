...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="bg-[#071E3D] w-screen h-screen relative">
        <nav className="flex justify-between items-center px-20 py-10 font-medium text-2xl text-white">
          <span className="text-[36px]">P<span className="text-[#21E6C1]">Mate</span></span>
        ...
        <div className="bg-[#278EA5] blur-[300px] rounded-full h-[200px] w-full absolute bottom-0"></div>
      </main> 
      </>
    );
};
